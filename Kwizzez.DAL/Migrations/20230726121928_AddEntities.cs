        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    HasLimitedTime = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StudentScores_AspNetUsers_ApplicationUserId",
                        column: x => x.ApplicationUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "StudentScoreAnswers",
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    StudentScoreId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StudentScoreAnswers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StudentScoreAnswers_Answers_AnswerId",
                        column: x => x.AnswerId,
                        principalTable: "Answers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_StudentScoreAnswers_StudentScores_StudentScoreId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StudentScoreAnswers_AnswerId",
                table: "StudentScoreAnswers",
                column: "AnswerId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentScoreAnswers_StudentScoreId",
                table: "StudentScoreAnswers",
                column: "StudentScoreId");

            migrationBuilder.CreateIndex(
                name: "IX_StudentScores_ApplicationUserId",
                table: "StudentScores",
                column: "ApplicationUserId");
